...
export _daysecs,
       ...
       _minTimezoneNumber, _maxTimezoneNumber, _topTimezoneNumber, 
...
const _topTimezoneNumber = (512)
const _minTimezoneNumber = (1)
const _maxTimezoneNumber = (_topTimezoneNumber - 1)
