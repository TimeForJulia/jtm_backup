# source : daynum.jl  (./extras/tm4julia/days/)
...
# verified
# daynum2ymd(unchecked_daynumber(y,m,d)) == y,m,d forall dates allowed
...
#
#   Notes
#   to obtain the corresponding signed daynumber subtract 1607067
#
#   (y,m,d)       --> daynumber, signed correspondant
#
...
# uncheckd_daynumber original form
# function daynumber_unsafe(y,m,d)
...
function unchecked_daynumber(y::Int, m::Int, d::Int)
...
function daynumber(y::Int, m::Int, d::Int)
  if (_minYear <= y <= _maxYear)
     unchecked_daynumber(y,m,d)
  end
end
...
function daynumber2ymd(J::Int64)
...
mjday2ymd(mjday::Integer)         =  daynumber2ymd(mjday2daynumber(mjday))


daynumber2taiday(daynum::Integer) =  daynum - _TAI_day0
taiday2daynumber(taiday::Integer) =  taiday + _TAI_day0
taiday2ymd(taiday::Integer)       =  daynumber2ymd(taiday2daynumber(taiday))


daynumber2nixday(daynum::Integer) =  daynum - _NIX_day0
nixday2daynumber(nixday::Integer) =  nixday + _NIX_day0
nixday2ymd(nixday::Integer)       =  daynumber2ymd(nixday2daynumber(nixday))

nixday2mjday(nixday::Integer)     =  daynumber2mjday(nixday2daynumber(nixday))
mjday2nixday(mjday::Integer)      =  daynumber2nixday(mjday2daynumber(mjday))
...
#             dnum = unchecked_daynumber(y,m,d)
